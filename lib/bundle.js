...
/***/ function(module, exports, __webpack_require__) {
	...
	document.getElementById("Start").addEventListener("click", function () {
	  ...
	  var savedGame = setInterval(game.animate.bind(game, ctx, canvas), 5);
	...
	var Game = function () {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function drawTimer(ctx) {
	      ctx.font = "26px Arial";
	      ctx.fillStyle = "black";
	      ctx.fillText(Math.round(this.counter), 367, 687);
	    }
	  }, {
	    key: "refreshTimer",
	    ...
	    value: function animate(ctx, canvas) {
	      ...
	      ctx.beginPath();
	      ctx.fillText(this.level, 367, 650);
	      this.drawScore(ctx);
	      this.drawTimer(ctx);
	    ...
	    value: function drawScore(ctx) {
	      ctx.font = "26px Arial";
	      ctx.fillStyle = "black";
	      ctx.fillText(this.score, 160, 655);
	      ctx.fillText("Drops:  " + this.losses, 68, 685);
	    }
	  }]);
