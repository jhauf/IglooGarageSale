...
export default class Game {
  ...
  drawTimer(ctx) {
     ...
     ctx.fillStyle = "black";
     ctx.fillText("Timer: " + Math.round(this.counter), 520, 680);
  }
  ...
  animate(ctx, canvas) {
    ...
    ctx.beginPath();
    ctx.fillText("Level:  " + this.level, 385, 680);
    this.drawScore(ctx);
    this.drawTimer(ctx);
  ...
  drawScore(ctx) {
    ctx.font = "28px Bangers";
    ctx.fillStyle = "black";
    ctx.fillText("Score:  " + this.score, 230, 680);
    ctx.fillText("Drops:  "+this.losses, 68, 680);
  }
}
